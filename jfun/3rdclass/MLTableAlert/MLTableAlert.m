...
-(void)show
{
	...
	// setting alert background
    self.alertBg.backgroundColor = [UIColor colorWithRed:229/255.0 green:127/255.0 blue:65/255.0 alpha:1.0];
	self.alertBg.layer.cornerRadius=6.0;
    self.alertBg.layer.shadowColor = [[[UIColor blackColor] colorWithAlphaComponent:0.85f] CGColor];
    self.alertBg.layer.shadowOffset =  CGSizeMake(0, -1);
	...
	[self.cancelButton setBackgroundColor:[UIColor colorWithRed:231/255.0 green:135/255.0 blue:33/255.0 alpha:255/255.0]];
	...
	self.cancelButton.layer.cornerRadius = kCancelButtonHeight/2;
	...
	self.alertBg.frame = CGRectMake((self.frame.size.width - kTableAlertWidth) / 2, (self.frame.size.height - self.height) / 2, kTableAlertWidth, self.height - kVerticalInset);
